"""
vision/screen_vision.py — JARVIS OMEGA V11
...
class ScreenReader:
    def __init__(self, settings: dict):
        ...
        self.vision_model = settings.get("V11_MODELS", {}).get("vision", "qwen3-vl:2b")

    def screenshot(self) -> Optional[str]:
        """Take a screenshot, save to data/screenshots/, return path."""
        ...
        if PIL:
            try:
                ...
                print(f"[VISION] PIL screenshot error: {e}")
        ...
        if PYAUTOGUI:
            try:
                ...
                print(f"[VISION] pyautogui screenshot error: {e}")
